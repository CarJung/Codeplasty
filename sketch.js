...
function draw() {
  t++;
  if(t%100==0){
  loadJSON("https://human-tech-hackaton-22.vercel.app/api/codeplasty-transparency-one",
   (payload)=>
  { good=int(payload.transparency_one)})

  loadJSON("https://human-tech-hackaton-22.vercel.app/api/codeplasty-transparency-two",
   (payload)=>
